...
== Which [.mark]#static site generator# to choose?

[.lora]
Is Hexo worth considering?
...
icon:check[role="green"] Git [.mark]#*source code*# repository created +
icon:check[role="green"] File format chosen _(Markdown, AsciiDoc, ...)_ +
icon:check[role="green"] Static site [.mark]#*generator*# chosen +
icon:check[role="green"] A few first blog posts [.mark]#*written*#
...
== What about [.mark]#CICD#+++<sup class="red">*</sup>+++?

[.lora]
Deploy on *commit*. From *anywhere*.
...
icon:check[role="green"] Automated and [.mark]#*recoverable*# environment
